        ...
        <div class="row no-margin no-padding">
            <div class="col-xs-9 no-margin">
                <div class="panel heightSet900">
                    <h2>Naive Bayes Details</h2>
                    <div id="algoTree">
                        <span data-bind="text: generateMlTree('pages/research/algo_nb.json');"></span>
                    </div>
                </div>
            </div>
            <div class="col-xs-3">
                <div class="panel panel-info heightSet900">
                    ...
                    <div class="panel-body heightSet900">
                        <span data-bind="text: quickDetailsFunc('nb', 'pages/research/algo_nb_links.json')"></span>
