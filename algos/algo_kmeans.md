        ...
        <div class="row no-margin no-padding">
            <div class="col-xs-9 no-margin">
                <div class="panel heightSet900">
                    <h2>K-Means Details</h2>
                    <div id="algoTree">
                        <span data-bind="text: generateMlTree('pages/research/algo_kmeans.json');"></span>
                    </div>
                </div>
            </div>
            <div class="col-xs-3">
                <div class="panel panel-info heightSet900">
                    ...
                    <div class="panel-body heightSet900">
                        <span data-bind="text: quickDetailsFunc('kmeans', 'pages/research/algo_kmeans_links.json')"></span>
