...
val autoMpgData = new H2OFrame(new File("/Users/avkashchauhan/src/github.com/avkash/mldl/data/auto_mpg.csv"))
## ---> DELETE <--- val autoMpgData = new H2OFrame(new File("/Users/avkashchauhan/learn/customers/au.csv"))
