...
## Get the Sample Python Source Jupyter Notebook ##
  - [H2O_Kmeans with Driver-Delivery-Speed Dataset in Python](https://github.com/Avkash/mldl/blob/master/notebook/h2o/H2O-Kmeans-DriverDeliverySpeed.ipynb)
